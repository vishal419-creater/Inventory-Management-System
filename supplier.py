...
class supplierClass:
    def __init__(self,root):
        ...
        #============================
        # All Variable===============
        self.var_searchby=Stringby=StringVar()
    ...
    def add(self):
        ...
        try:
            if self.var_sup_invoice.get()=="":
                ...
                row=cur.fetchone()
                if row!=None:
                    messagebox.showerror("Error","Invoice no. is already assigned, try with different one.",parent=self.root)
                else:
        ...
        try:
            if self.var_sup_invoice.get()=="":
                ...
                if row==None:
                    ...
                    op=messagebox.askyesno("Cnfirm","Do you really want to delete?",parent=self.root)
                    if op==True:
