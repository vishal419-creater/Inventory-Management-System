...
class employeeClass:
    def __init__(self,root):
        ...
        txt_dob=Entry(self.root,textvariable=self.var_dob,font=("guido old style",15),bg="lightyellow").place(x=500,y=190,width=180)
        ...
        txt_pass=Entry(self.root,textvariable=self.var_pass,font=("guido old style",15),bg="lightyellow").place(x=500,y=230,width=180)
        ...
        txt_salary=Entry(self.root,textvariable=self.var_salary,font=("guido old style",15),bg="lightyellow").place(x=600,y=270,width=180)       
    ...
    def add(self):
        ...
        try:
            if self.var_emp_id.get()=="":
                ...
                row=cur.fetchone()
                if row!=None:
                    messagebox.showerror("Error","This employee ID is already present, try with different one.",parent=self.root)
                else:
